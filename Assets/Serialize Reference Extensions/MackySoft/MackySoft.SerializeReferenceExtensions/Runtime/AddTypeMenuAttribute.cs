...
public sealed class AddTypeMenuAttribute : Attribute
{
    ...
    static readonly char[] k_Separators = new char[] { '/' };
    ...
    {
        return !string.IsNullOrWhiteSpace(MenuName) ? MenuName.Split(k_Separators, StringSplitOptions.RemoveEmptyEntries) : Array.Empty<string>();
    }
